...
class RideListTest(TestCase):
    ...
    def test_get_ride_list(self):
        resp = self.client.get('/route/1/ride', headers=self.headers,
                               content_type='application/json')
        get_ride_response_data = json.loads(resp.data)
        self.assertEquals(resp.status_code, 200)
        self.assertEquals(len(get_ride_response_data), 2)
    ...
    def test_post_ride_list(self):
        ...
        resp = self.client.post('/route/1/ride', headers=self.headers,
